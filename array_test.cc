...
public:
   ...
   void DynamicIndexingReadWrite();
   void IndexingReadWriteBool();
   void Fill();
   void DataPointer();
   void Stringification1D();
   void Stringification2D();
   void Stringification3D();
   void Each();
   void Slice();
   void UpdateSlice();
};

void ArrayTest::UninitializedDimsCtor()
{
...
void ArrayTest::InitializerListCtor()
{
...
void ArrayTest::IndexingReadWrite()
{
  Array<int> arr({2, 3});
...
void ArrayTest::DynamicIndexingReadWrite()
{
  Array<int> arr({2, 3});
...
void ArrayTest::IndexingReadWriteBool()
{
...
void ArrayTest::DataPointer()
{
  Array<int> arr{{1, 2, 3}, {4, 5, 6}};
  EXPECT_EQ(arr.data()[0], 1);
}

void ArrayTest::Stringification1D()
{
  Array<int64> arr({2}, 1);
...
void ArrayTest::Stringification2D()
{
...
void ArrayTest::Stringification3D()
{

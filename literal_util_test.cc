...
public:
   ...
   void LiteralScalarToString();
   void LiteralVectorToString();
   void R2ToString();
   void R3ToString();
   void TupleToString();
   void CreateR3FromArray3d();
   void LiteralR4F32ProjectedStringifies();
   void LiteralR4F32Stringifies();
   void EachCellR2F32();
   void ScalarEquality();
   void NonScalarEquality();
   void DifferentLayoutEquality();
   void TupleEquality();
   void IsAllTuple();
   void IsAll();
   void IsAllFloat();
   ...
   void TransposeR0();
   void TransposeR4();
   void TestR4RelayoutEquivalence();
   void TestR2LinearLayout();
   void TestR3LinearLayout();
   void SliceR0S32();
   void SliceR1F32();
   void SliceR2U32();
   void SliceR3U32Full();
...
void LiteralUtilTest::run()
{
   ...
   TupleToString();
   CreateR3FromArray3d();
   LiteralR4F32ProjectedStringifies();
   LiteralR4F32Stringifies();
   EachCellR2F32();
   ScalarEquality();
   NonScalarEquality();
   DifferentLayoutEquality();
   TupleEquality();
   IsAllTuple();
   IsAll();
   IsAllFloat();
   ...
   PopulateR1S64();
   PopulateR2U64();
   PopulateWithValueR0F32();
   PopulateWithValueR1S64();
   PopulateWithValueR2U64();
}


void LiteralUtilTest::LiteralScalarToString()
{
...
void LiteralUtilTest::R2ToString()
{
  ...
  string str = LiteralUtil::ToString(*literal);
  ASSERT_EQ(expected, LiteralUtil::ToString(*literal));
}

void LiteralUtilTest::R3ToString()
{
  const auto literal =
...
void LiteralUtilTest::TupleToString()
{
...
void LiteralUtilTest::CreateR3FromArray3d()
{
  // clang-format off
...
void LiteralUtilTest::LiteralR4F32ProjectedStringifies()
{
  // clang-format off
...
void LiteralUtilTest::LiteralR4F32Stringifies()
{
  EXPECT_MATCH(
...
void LiteralUtilTest::EachCellR2F32()
{
  // clang-format off
...
void LiteralUtilTest::ScalarEquality()
{
...
void LiteralUtilTest::NonScalarEquality()
{
...
void LiteralUtilTest::DifferentLayoutEquality()
{
...
void LiteralUtilTest::TupleEquality()
{
...
void LiteralUtilTest::IsAllTuple()
{
...
void LiteralUtilTest::IsAll()
{
  ...
  EXPECT_TRUE(LiteralUtil::IsAll(*LiteralUtil::CreateR0<float>(42.0f), 42));
  EXPECT_FALSE(LiteralUtil::IsAll(*LiteralUtil::CreateR0<float>(42.0001f), 42));
...
void LiteralUtilTest::IsAllFloat()
{
  ...
  EXPECT_TRUE(LiteralUtil::IsAllFloat(*LiteralUtil::CreateR0<float>(.5f), .5f));
  EXPECT_TRUE(LiteralUtil::IsAllFloat(*LiteralUtil::CreateR0<float>(-.5f), -.5f));
  EXPECT_FALSE(
      LiteralUtil::IsAllFloat(*LiteralUtil::CreateR0<float>(-.5f), -.49f));
  EXPECT_FALSE(LiteralUtil::IsAllFloat(
      *LiteralUtil::CreateR2<float>({{0.f, 0.f, 0.f}, {0.f, .1f, 0.f}}), 0.f));
  EXPECT_TRUE(LiteralUtil::IsAllFloat(
      *LiteralUtil::CreateR2<float>({{.5f, .5f, .5f}, {.5f, .5f, .5f}}), .5f));
  ...
  EXPECT_TRUE(
      LiteralUtil::IsAllFloat(*LiteralUtil::CreateR0<double>(-.5), -.5f));
  EXPECT_FALSE(
      LiteralUtil::IsAllFloat(*LiteralUtil::CreateR0<double>(-.5), -.49f));
  EXPECT_FALSE(LiteralUtil::IsAllFloat(
      *LiteralUtil::CreateR2<double>({{0, 0, 0}, {0, .1, 0}}), 0));
}

void LiteralUtilTest::IsZero()
{
...
*/
void LiteralUtilTest::ReshapeR0()
{
...
void LiteralUtilTest::ReshapeR4()
{
  // clang-format off
  // F32[1x3x2x4]
...
void LiteralUtilTest::TransposeR0()
{
  auto original = LiteralUtil::CreateR0<float>(1.7f);
...
void LiteralUtilTest::TransposeR4()
{
  // clang-format off
  // F32[1x3x2x4]
...
void LiteralUtilTest::TestR4RelayoutEquivalence()
{
...
void LiteralUtilTest::TestR2LinearLayout()
{
...
void LiteralUtilTest::TestR3LinearLayout()
{
...
void LiteralUtilTest::SliceR0S32()
{
...
void LiteralUtilTest::SliceR1F32()
{
...
void LiteralUtilTest::SliceR2U32()
{
...
void LiteralUtilTest::SliceR3U32Full()
{
...
void LiteralUtilTest::PopulateR1S64()
{
  Literal output;
...
void LiteralUtilTest::PopulateR2U64()
{
  Literal output;
...
void LiteralUtilTest::PopulateWithValueR0F32()
{
  Literal output;
...
void LiteralUtilTest::PopulateWithValueR1S64()
{
  Literal output;
...
void LiteralUtilTest::PopulateWithValueR2U64()
{
  Literal output;

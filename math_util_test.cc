                     ...
                     int num_tests) 
{
  ...
  {
    const IntegralType numerator = static_cast<IntegralType>( test_data[i][0] );
    const IntegralType denominator = static_cast<IntegralType>( test_data[i][1] );
    const IntegralType expected_floor = static_cast<IntegralType>( test_data[i][2] );
    const IntegralType expected_ceil = static_cast<IntegralType>( test_data[i][3] );

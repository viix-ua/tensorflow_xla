...
public:
  ...
  PadTest() {
    ...
    /*auto*/ xla::PaddingConfig_PaddingConfigDimension* dimension0 = r4_padding_on_dim0_dim1_.add_dimensions();
    dimension0->set_edge_padding_low(1);
    dimension0->set_edge_padding_high(0);
    dimension0->set_interior_padding(2);
    /*auto*/ xla::PaddingConfig_PaddingConfigDimension* dimension1 = r4_padding_on_dim0_dim1_.add_dimensions();
    dimension1->set_edge_padding_low(0);
    dimension1->set_edge_padding_high(2);
    dimension1->set_interior_padding(1);
    /*auto*/ xla::PaddingConfig_PaddingConfigDimension* dimension2 = r4_padding_on_dim0_dim1_.add_dimensions();
    dimension2->set_edge_padding_low(0);
    dimension2->set_edge_padding_high(0);
    dimension2->set_interior_padding(0);
    /*auto*/ xla::PaddingConfig_PaddingConfigDimension* dimension3 = r4_padding_on_dim0_dim1_.add_dimensions();
  ...
  void Pad1DS0ToS5Array();
  void Pad1DS3Array();
  void Pad4D_2x0x3x2_FloatArray();
  void Pad4DFloat_1x1x3x2_Array();
  void Pad4DFloatArrayWithInteriorPadding();
  void Pad4DFloatArrayMinorFirstSmall();
  void Pad4DFloatArrayMinorFirstNonTrivialMinorDimensions();
  void Pad4DU8Array();
  void Pad4DPredArray();
  void Large2DPad();
  void AllTypes2DPad();
  void High2DPad();
  void NegativePadding2D();
  void NegativeAndInteriorPadding2D();
  void ReducePad();
...
void PadTest::Pad1DS0ToS0Array()
{
  ComputationBuilder b(TestName());
  // Set up the padding configuration {low: 0, high: 0, interior: 0}.
  PaddingConfig padding_config;
  /*auto*/ xla::PaddingConfig_PaddingConfigDimension* dimension = padding_config.add_dimensions();
  dimension->set_edge_padding_low(0);
  dimension->set_edge_padding_high(0);
  dimension->set_interior_padding(0);

  b.Pad(b.ConstantR1<float>({}), b.ConstantR0<float>(0.1f), padding_config);
  ComputeAndCompareR1<float>(&b, {}, {}, ErrorSpec(0.0001f));
}

// Tests a Pad() with a zero-element input but a non-zero-element output.
void PadTest::Pad1DS0ToS5Array() 
{
  ComputationBuilder b(TestName());
  ...
  b.Pad(b.ConstantR1<float>({}), b.ConstantR0<float>(0.1f), padding_config);
  ComputeAndCompareR1<float>(&b, std::vector<float>(5, 0.1f), {},
                             ErrorSpec(0.0001f));
}

void PadTest::Pad1DS3Array() 
{
  ComputationBuilder b(TestName());
  // Set up the padding configuration {low: 3, high: 0, interior: 1}.
  PaddingConfig padding_config;
  ...
  b.Pad(b.ConstantR1<float>({1.f, 2.f, 3.f}), b.ConstantR0<float>(0.1f),
        padding_config);
  std::vector<float> expected({0.1f, 0.1f, 0.1f, 1.f, 0.1f, 2.f, 0.1f, 3.f});
  ComputeAndCompareR1<float>(&b, expected, {}, ErrorSpec(0.0001f));
}

void PadTest::Pad4D_2x0x3x2_FloatArray() 
{
  ComputationBuilder b(TestName());
...
void PadTest::Pad4DFloat_1x1x3x2_Array() 
{
  ComputationBuilder b(TestName());
  ...
  ComputeAndCompareR4<float>(&b, *expected, {}, ErrorSpec(0.0001f));
}

void PadTest::Pad4DFloatArrayWithInteriorPadding() 
{
  ComputationBuilder b(TestName());
...
void PadTest::Pad4DFloatArrayMinorFirstSmall() 
{
  ComputationBuilder b(TestName());

  PaddingConfig padding_config;
  /*auto*/ xla::PaddingConfig_PaddingConfigDimension* dimension0 = padding_config.add_dimensions();
  dimension0->set_edge_padding_low(0);
  dimension0->set_edge_padding_high(0);
  dimension0->set_interior_padding(0);
  /*auto*/ xla::PaddingConfig_PaddingConfigDimension* dimension1 = padding_config.add_dimensions();
  dimension1->set_edge_padding_low(0);
  dimension1->set_edge_padding_high(0);
  dimension1->set_interior_padding(0);
  /*auto*/ xla::PaddingConfig_PaddingConfigDimension* dimension2 = padding_config.add_dimensions();
  dimension2->set_edge_padding_low(2);
  dimension2->set_edge_padding_high(1);
  dimension2->set_interior_padding(0);
  /*auto*/ xla::PaddingConfig_PaddingConfigDimension* dimension3 = padding_config.add_dimensions();
  ...
  ComputeAndCompareR4<float>(&b, expected_array, {}, ErrorSpec(0.0001f));
}

void PadTest::Pad4DFloatArrayMinorFirstNonTrivialMinorDimensions() 
{
  ComputationBuilder b(TestName());
...
void PadTest::NegativePadding2D() 
{
  ComputationBuilder b(TestName());
...
void PadTest::NegativeAndInteriorPadding2D() 
{
  ComputationBuilder b(TestName());

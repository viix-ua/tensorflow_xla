...
std::vector<std::pair<int64, int64>> MakePadding(
    const tensorflow::gtl::ArraySlice<int64>& input_dimensions,
    const tensorflow::gtl::ArraySlice<int64>& window_dimensions,
    const tensorflow::gtl::ArraySlice<int64>& window_strides, const Padding& padding) 
{
